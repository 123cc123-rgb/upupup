  ...
  setup(__props) {
    ...
    const get_data_func = () => {
      common_vendor.index.request({
        url: common_js_settings.base_url + "/get_yichang_list?search=" + common_vendor.index.getStorageSync("uuid"),
        method: "GET",
        success: (res) => {
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-2a2eb4d4"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../.sourcemap/mp-weixin/pages/mine/list1.js.map
