...
if (!Array) {
  ...
  (_easycom_up_search2 + _easycom_u_icon2 + _easycom_up_list_item2 + _easycom_up_list2)();
}
...
if (!Math) {
  (_easycom_up_search + _easycom_u_icon + _easycom_up_list_item + _easycom_up_list)();
}
const _sfc_main = {
  __name: "search_talk",
  setup(__props) {
    ...
    const get_data_func = () => {
      common_vendor.index.request({
        url: common_js_settings.base_url + "/get_my_talk?uuid=" + common_vendor.index.getStorageSync("uuid"),
        method: "GET",
        success: (res) => {
          common_vendor.index.__f__("log", "at pages/mine/search_talk.vue:75", "res: ", res);
      ...
      if (post) {
        ...
        if (post.isLiked === true) {
          common_vendor.index.request({
            ...
            success: (add_res) => {
              common_vendor.index.__f__("log", "at pages/mine/search_talk.vue:172", "add_res: ", add_res);
            }
          });
        } else {
          common_vendor.index.request({
            ...
            success: (qx_res) => {
              common_vendor.index.__f__("log", "at pages/mine/search_talk.vue:184", "qx_res: ", qx_res);
            }
          });
        }
      }
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-ab1a29b8"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../.sourcemap/mp-weixin/pages/mine/search_talk.js.map
