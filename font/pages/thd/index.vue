<template>
	<view class="container">
		<!-- 搜索栏 -->
		<up-search v-model="searchKeyword" placeholder="搜索帖子" :show-action="false" margin="20rpx 40rpx" height="6vh"
				...
				<view class="post-card">
					...
					<view class="comments">
						...
						<view class="add-comment">
							<u-input v-model="post.fabu_key" placeholder="写评论..." border="none"
								@confirm="addComment(post.id)">
							</u-input>
						</view>
					</view>
				</view>
		...
		<up-button type="primary" icon="edit-pen" shape="circle" style="width: 100rpx;height: 100rpx;position: fixed;bottom: 100rpx;right: 50rpx;"
			@click="navigateToPost"></up-button>
...
<script setup>
	...
	const get_data_func = ()=>{
		uni.request({
			url:base_url + '/get_talk?uuid='+uni.getStorageSync('uuid'),
			method:'GET',
			success: (res) => {
				console.log('res: ',res);
